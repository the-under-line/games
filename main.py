...
def a_chance_at_victory():
    ...
    print(f"You got a {weapon_choice[0]}! This weapon gives you {weapon_choice[1]}!\n")
    ...
    print(f"You got a {die_one} on your first die and a {die_two} on your second die! This totals to {total}!\n")
    ...
    print(f"Game is over! You got {points} points!")
    
    if points < 0:
        print("You lose. You beat 0 enemies.")
    elif points <= 7:
        print("You beat one enemy.")
    elif points <= 13:
        print("You beat two enemies!")
    elif points <= 19:
        print("You beat three enemies!!")
    elif points >= 20:
        print("You win! You beat ALL FOUR enemies!!!!")
